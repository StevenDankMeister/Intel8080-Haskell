...
instructionNotImplemented state = error "Instruction not implemented"

emulateProgram :: State8080 -> State8080
emulateProgram state = error "hej"--emulateProgram (emulateOp state)

emulateOp :: State8080 -> State8080
emulateOp state | op == 0x00 = state
